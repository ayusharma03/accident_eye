...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.logo_img = customtkinter.CTkImage(Image.open(os.path.join(image_path, "brand.png")),
                                               Image.open(os.path.join(image_path, "brand.png")), size=(100, 40))
        self.logo_label = customtkinter.CTkLabel(self.sidebar_frame, text=" ",image=self.logo_img , font=customtkinter.CTkFont(size=20, weight="bold"))
